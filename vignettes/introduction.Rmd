...
safely_show_image_Rmd <- function(IMAGE, name_image) {
  
  if (curl::has_internet()) {
    
    if (httr::http_error(IMAGE)) { # network down
      message("Data source not responding")
      return(NULL)
    } else { # network up
      paste0("![", name_image, "](", IMAGE, ")")
    }
...
cat(paste0("[", safely_show_image_Rmd(IMAGE = "https://www.r-pkg.org/badges/version/BayesianReasoning", name_image = "CRAN status"), "]", "(https://cran.r-project.org/package=BayesianReasoning)"))
cat(paste0("[", safely_show_image_Rmd(IMAGE = "https://codecov.io/gh/gorkang/BayesianReasoning/branch/master/graph/badge.svg", name_image = "Codecov test coverage"), "]", "(https://app.codecov.io/gh/gorkang/BayesianReasoning?branch=master)"))
cat(paste0("[", safely_show_image_Rmd(IMAGE = "http://cranlogs.r-pkg.org/badges/BayesianReasoning", name_image = "downloads"), "]", "(https://cran.r-project.org/package=BayesianReasoning)"))


cat(paste0("[", safely_show_image_Rmd(IMAGE = "https://img.shields.io/badge/lifecycle-experimental-orange.svg", name_image = "Lifecycle: experimental"), "]", "(https://lifecycle.r-lib.org/articles/stages.html#experimental)"))
cat(paste0("[", safely_show_image_Rmd(IMAGE = "https://zenodo.org/badge/93097662.svg", name_image = "DOI"), "]", "(https://zenodo.org/badge/latestdoi/93097662)"))
