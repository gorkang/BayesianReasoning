...
PPV_heatmap(min_Prevalence = 1, max_Prevalence = 1200, Sensitivity = 81, Specificity = 95,
...
```{r line}
PPV_heatmap(min_Prevalence = 1, max_Prevalence = 1800, Sensitivity = 90, Specificity = 85, 
