...
```{r plot2, fig.height=8, fig.width=10}
...
```{r plot_area1, fig.height=8, fig.width=10}
...
```{r plot_line1, fig.height=8, fig.width=10}
...
```{r plot_line2, fig.height=8, fig.width=10}
...
```{r plot_diagnostic, fig.height=8, fig.width=10}
...
```{r min_possible_prev1, fig.height=8, fig.width=10}
...
```{r min_possible_prev2, fig.height=8, fig.width=10}
